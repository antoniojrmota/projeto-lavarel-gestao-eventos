    ...
    <div id="event-create-container" class="col-md-6 offset-md-3">
        ...
        <form action="/eventos/update/{{ $evento->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <img src="/assets/img/eventos/{{ $evento->image }}" alt="{{ $evento->title}}" class="img-preview">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="date" name="date" value="{{date('Y-m-d', strtotime($evento->date))}}">
            </div>
            <div class="form-group">
